...
@Component({
  selector: 'app-cn-horizontal-barchart',
  templateUrl: './cn-horizontal-barchart.component.html',
  styles: [`
  .g2-label-item {
        font-size: 10px;
        text-align: center;
...
export class CnHorizontalBarchartComponent extends CnComponentBase
